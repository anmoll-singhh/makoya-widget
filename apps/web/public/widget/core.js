...
`;function he(){if(document.getElementById(Z))return;const e=document.createElement("style");e.id=Z,e.textContent=pe,document.head.appendChild(e)}function k(e,t){const o=document.documentElement;t===null?o.removeAttribute(e):o.setAttribute(e,t)}const $="makoya_prefs",T={text:0,spacing:!1,contrast:"off",stopMotion:!1,ruler:!1,links:!1,cursor:"off",font:!1,images:!1,saturation:"off",mask:"off",titles:!1,align:!1,mute:!1,readAloud:!1};function X(){try{const e=localStorage.getItem($);return e?{...T,...JSON.parse(e)}:{...T}}catch{return{...T}}}function me(e){try{localStorage.setItem($,JSON.stringify(e))}catch{}}function J(e){he(),k("data-mky-text",e.text===0?null:String(e.text)),k("data-mky-spacing",e.spacing?"on":null),k("data-mky-contrast",e.contrast==="off"?null:e.contrast),k("data-mky-motion",e.stopMotion?"off":null),k("data-mky-links",e.links?"on":null),k("data-mky-cursor",e.cursor==="off"?null:e.cursor),k("data-mky-font",e.font?"on":null),k("data-mky-images",e.images?"off":null),k("data-mky-sat",e.saturation==="off"?null:e.saturation),k("data-mky-titles",e.titles?"on":null),k("data-mky-align",e.align?"on":null)}const fe={sm:48,md:56,lg:64};function ge(e,t){const o=fe[t],i=Math.round(o*.5/2)*2;return`
/* ─────────────────────────────────────────────────────────────────────────
   RESET + HOST
   ───────────────────────────────────────────────────────────────────────── */
:host {
