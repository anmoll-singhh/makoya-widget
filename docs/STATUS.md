...
| | |
|---|---|
| **Current phase** | **block 31 — accessiBe-parity widget (35 features) built + 5x agent-reviewed; merging `feat/widget-accessibe-parity`→`main` + deploying.** Prior live (blocks 26–30): motion/mobile, i18n, scalability/config-cache/scanner-queue, licensing hardening. next = **Stripe** + **Supabase Pro** (free tier auto-pauses) + AI-Simplify widget UI (backend ready, OFF) |
