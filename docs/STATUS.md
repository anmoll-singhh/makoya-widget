...
| | |
|---|---|
| **Current phase** | **prod == `main` (block 30 deploy caught prod up — blocks 26–30 now ALL LIVE):** motion/mobile, i18n, 18 widget features, scalability/config-cache/scanner-queue, licensing hardening. next = **Stripe** + **Supabase Pro** (free tier auto-pauses) |
