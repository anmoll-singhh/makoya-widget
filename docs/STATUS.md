...
| | |
|---|---|
| **Current phase** | **v7 prod is LIVE but `main` has moved far past it** (blocks 26 motion/mobile, i18n, batch-2 widget features, block 27 scalability — all merged, **none deployed**). next = **deploy `main` to prod** · then **Stripe** + **Supabase Pro** (free tier auto-pauses) |
